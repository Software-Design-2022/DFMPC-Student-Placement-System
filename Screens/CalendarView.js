...
/**
 * @module CalendarView
 * @description Screen that displays the calendar and allows the user to add events to the calendar
 * @returns {JSX.Element} Screen that displays the calendar with the events
 */
